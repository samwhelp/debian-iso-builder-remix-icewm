...
| `+` | `+` |
| [debian-iso-builder-remix-icewm](https://samwhelp.github.io/debian-iso-builder-remix-icewm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-remix-icewm) |
| `=` | `=` |
| [debian-iso-builder-respin-icewm](https://samwhelp.github.io/debian-iso-builder-respin-icewm/) | [GitHub](https://github.com/samwhelp/debian-iso-builder-respin-icewm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-icewm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-icewm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-icewm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-icewm](https://github.com/samwhelp/debian-iso-builder-remix-icewm)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-icewm.git
```


> change dir to `debian-iso-builder-remix-icewm`

``` sh
cd debian-iso-builder-remix-icewm
```
...
> change dir to `~/work/debian-iso-builder-remix-icewm/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-icewm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-icewm/iso-profile/dist`
